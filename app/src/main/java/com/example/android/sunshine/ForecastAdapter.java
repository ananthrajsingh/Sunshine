...
//      TODO (4) Replace the weatherSummary TextView with individual weather detail TextViews
        final TextView weatherConditionTV;
        final TextView weatherDateTV;
...
//          TODO (6) Get references to all new views and delete this line
            weatherConditionTV = (TextView) view.findViewById(R.id.textViewWeather);
            weatherDateTV = (TextView) view.findViewById(R.id.textViewDay);
            maxTempTV = (TextView) view.findViewById(R.id.textViewTempMax);
            minTempTV = (TextView) view.findViewById(R.id.textViewTempMin);
            weatherImageView = (ImageView) view.findViewById(R.id.imageView);
