...
//  TODO (1) Create a constant int value to identify the notification
    ...
    //This constant can be used later to access the notification. This is very useful for updates and for cancelling ongoing
    //notifications, things like that
    public static final int SUNSHINE_NOTIFICATION_ID = 1234;
